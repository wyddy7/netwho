...
- [ ] Тест: `pending` пользователь не может создать контакт в орге
- [ ] Тест: `approved` пользователь может создавать контакты
- [ ] Логи показывают корректную проверку статуса
